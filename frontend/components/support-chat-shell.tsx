...
import { Maximize2, MessageCircle, ShieldCheck } from 'lucide-react'
...
export function SupportChatShell({ mode }: SupportChatShellProps) {
  ...
  const containerHeight = mode === 'full' ? 'min-h-[70dvh]' : 'h-[24rem]'
  ...
  return (
    <section className="flex h-full flex-col overflow-hidden rounded-2xl border border-border/70 bg-background/95 backdrop-blur">
